...
urlpatterns = [
    ...
    path('parties/<int:viewingparty_id>/add_party_photo/', views.add_party_photo, name='parties_add_photo'),
    path('parties/<int:viewingparty_id>/delete_party_photo/', views.delete_party_photo, name='parties_delete_photo'),
